# OCL Language Specification — Prototype 0.15

This document describes only the implemented 0.15 subset. It is not a stability promise for later OCL releases.
