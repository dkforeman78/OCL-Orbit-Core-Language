# OCL Language Specification — Prototype 0.14

This document describes only the implemented 0.14 subset. It is not a stability promise for later OCL releases.
